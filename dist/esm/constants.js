 ...
 * Coders.
 */
export const TRIBECA_CODERS = buildCoderMap(TRIBECA_IDLS, TRIBECA_ADDRESSES);
 ...
 */
export const DEFAULT_LOCKER_PARAMS = {
  // 1M tokens if max locked.
  proposalActivationMinVotes: new BN(10000000 * Math.pow(10, 6)),
  // 1 day.
